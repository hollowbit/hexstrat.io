...
public class BlitzTurnType extends TurnType implements HexTouchListener {
	...
	public BlitzTurnType(Unit unit) {
		super(unit);
	}

	@Override
	public TextButton getTurnButton () {
		return new TextButton("Blitz", StrategyGame.getGame().getSkin());
	}
	...
	public void turnStart() {
		attacked = false;
		this.movesLeft = unit.getMoveSpeed() * 3;
		cooldown--;
	}

	@Override
	public boolean usable() {
		return cooldown <= 0 && movesLeft > 0 && !unit.isFinishedTurn() && (unit.getTurnTypeSet() == null || unit.getTurnTypeSet() == this);
	}
